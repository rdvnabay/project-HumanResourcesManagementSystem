...
export default function Footer() {
  return (
    <div className="pt-12">
      <footer id="footer" className="relative z-50 dark:bg-gray-900 pt-4">
                ...
                <div className="w-full lg:w-1/2 px-6">
                  <ul>
                    ...
                    <li className="mt-4">
                        ...
                        <NavLink
                        to="" className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50">
                          Pricing
                        </NavLink>
