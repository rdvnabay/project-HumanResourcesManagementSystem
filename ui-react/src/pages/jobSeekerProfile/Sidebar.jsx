        ...
        <div className="px-8">
          ...
          <ul className="mt-12">
            <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
              <div className="flex items-center">
                ...
                <NavLink to="/profile/bilgilerim">
                <span className="text-sm  ml-2">Bilgilerim</span>
                </NavLink>
               
              </div>
              <div className="py-1 px-3 bg-red-500 rounded text-white flex items-center justify-center text-xs">
                5
              </div>
            </li>
            <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
              <div className="flex items-center">
                ...
                <span className="text-sm  ml-2">Ön Yazılarım</span>
              </div>
            ...
            <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
              <div className="flex items-center">
                ...
                <NavLink to="/profile/egitim">
                <span className="text-sm  ml-2">Eğitim Bilgileri</span>
                </NavLink>
              </div>
            </li>
            <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
              <div className="flex items-center">
                ...
                <NavLink to="/profile/ayarlar">
                <span className="text-sm  ml-2">Ayarlar</span>
                </NavLink>
              </div>
            </li>
            <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
              <div className="flex items-center">
                ...
                <span className="text-sm  ml-2">Sertifikalarım</span>
              </div>
            ...
            <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
              <div className="flex items-center">
                ...
                <span className="text-sm  ml-2">Hobilerim</span>
              </div>
            </li>
            <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center">
              <div className="flex items-center">
                ...
                <span className="text-sm  ml-2">Yeteneklerim</span>
              </div>
            </li>
          </ul>
          <div className="flex justify-center mt-48 mb-4 w-full">
            <div className="relative ">
              ...
              <input
                className="bg-gray-100 focus:outline-none rounded w-full text-sm text-gray-600  pl-10 py-2"
                type="text"
